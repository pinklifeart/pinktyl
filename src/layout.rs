...
[[KeyCode(Escape),NoAction],[KeyCode(A),NoAction],[KeyCode(S),NoAction],[KeyCode(D),NoAction],[KeyCode(F),NoAction],[KeyCode(G),NoAction],
    [KeyCode(H),KeyCode(LeftArrow)],[KeyCode(J),KeyCode(DownArrow)],[KeyCode(K),KeyCode(UpArrow)],[KeyCode(L),KeyCode(RightArrow)],[KeyCode(Semicolon),NoAction],[KeyCode(Apostrophe),NoAction]],
